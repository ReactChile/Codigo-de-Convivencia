...
Reglas de convivencia para los integrantes de la Comunidad React Chile.

> **React Chile** es una Comunidad chilena dedicada a disfrutar, conversar, enseñar y aprender sobre Reactjs. Queremos destacarnos por ser una comunidad inclusiva y respetuosa con cada uno de sus miembros. Es por ello que hemos decidido elaborar un código de conducta que nos permita establecer normas mínimas de convivencia dentro de la comunidad y eventos organizados por ésta. 
...
- Queda prohibido publicar cursos, libros, videos tutoriales y/o cualquier material de pago que haya sido pirateado u obtenido de forma ilegal, a menos que el creador o propietario indique lo contrario y decida compartir dicho contenido.
...
## Hashtag en publicaciones (opcional, pero recomendado)
Para organizar y facilitar de mejor manera la búsqueda del contenido en nuestra comunidad, las publicaciones que se compartan en React Chile pueden utilizar un hashtag (#) con el tema que van a publicar. Se propone la siguiente convención:

- *#(Lenguaje de Programación):* Hashtag para publicaciones relacionadas sobre algún lenguaje de programación especifico. Ejemplo: #Javascript
- *#Reactjs:* Hashtag para publicaciones relacionadas con la librería de React.
- *#Pregunta #(Tecnología):* Hashtag para preguntar en nuestra comunidad, ejemplo: #Pregunta #ReactJs.
...
- *#Concurso:* Hashtag para publicaciones con el fin de promover un concurso. Los concursos son generados únicamente por administradores y moderadores de la comunidad.
...
**Para lo anterior las medidas serán:**
- Para las publicaciones sin Hashtag no existirá alguna sanción, pero el fin de nuestra comunidad es compartir, por ello, creemos que esto es una excelente forma de organizar el contenido que compartimos.
...
- Solo se permitirá publicidad si la marca o empresa realiza algún aporte en productos, monetario o tecnológico para la comunidad de React Chile. Dichos ingresos serán destinados a mejorar la calidad de los eventos futuros a realizar.
...
- Descuentos para los miembros de React Chile.
...
Para revisar nuestra pauta de ofertas laborales, clic aquí: [Pauta Ofertas Laborales](https://github.com/ReactChile/pautaOfertasLaborales)

## Consideraciones Importantes
- Los administradores de la Comunidad React Chile no son responsables por los acuerdos de negocios que los miembros del grupo hagan con terceros o entre ellos mismos.
...
- Si tienes dudas sobre nuestra comunidad, contáctate con nuestros Administradores o Moderadores y nos comunicaremos a la brevedad para darle alguna solución a tu inquietud.
